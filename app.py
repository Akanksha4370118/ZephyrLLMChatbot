...
class LiftingRulesApp:
    def __init__(self) -> None:
        self.documents = []
        self.embeddings = None
        self.index = None
        self.model = SentenceTransformer('all-MiniLM-L6-v2')
        self.load_pdf("NewRulesOfLifting.pdf")
    ...
    def load_pdf(self, file_path: str) -> None:
        ...
        print("The New Rules of Lifting PDF processed successfully!")
...
with demo:
    gr.Markdown(
        """‼️Disclaimer: This chatbot is based on 'The New Rules of Lifting' by Lou Schuler and Alwyn Cosgrove. It's for informational purposes only. Always consult with a certified fitness professional before starting any new exercise program.‼️"""
    )
    ...
    chatbot = gr.ChatInterface(
        ...
        title='New Rules of Lifting Assistant 💪🏋️‍♀️'
    )
